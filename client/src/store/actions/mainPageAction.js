...
export const getCourses = ( path ) => {
    return async dispatch => {
        ...
        try {
            await axiosApp.get(`/${ path }`)
            
                .then( res => {
                    let courses = res.data
                    console.log("Main page data", res)
...
export const clearCourses = () => {
    return {
        type: CLEAR_MAINPAGE_COURSES
    }
}

export const setCurentCourse = course => {
    return {
